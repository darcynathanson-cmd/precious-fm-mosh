...
- **✨ Surprise me** — rolls a brand-new **totally random** full look every press (random preset, sliders, colour, and a random mix of the glitch / stack / vignette effects), bounded so it stays usable. Hit undo to step back to your previous look.
